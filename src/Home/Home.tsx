        ...
        <Row>
            ...
            <Card
              title={
                <Typography.Title level={3}>
                  Find a Centre <VaccineIcon />
                </Typography.Title>
              }
            >
              <Typography.Paragraph>
                Search for a vaccination centre near you by your district,
                tehsil or name
              </Typography.Paragraph>
              <Link to="/centres">
                <Button type="primary" icon={<SearchHospitalIcon />}>
                  Search for a centre
                </Button>
              </Link>
            </Card>
          ...
          <Col xs={24}>
            <Card
              title={
                <Typography.Title level={3}>
                  Explore all cities <VaccineIcon />
                </Typography.Title>
              }
            >
              <Typography.Paragraph>
                Centre is probably available near you, even if you live in a
                remote mountainous area of Pakistan. Check out all these cities
              </Typography.Paragraph>
              <Link to="/cities">
                <Button type="primary" icon={<SearchHospitalIcon />}>
                  Explore All Cities
