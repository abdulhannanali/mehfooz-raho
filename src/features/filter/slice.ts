...
export const selectFetchState = (state: RootState) => selectFilterState(state).fetchState
export const selectDistricts = (state: RootState) => selectFilterState(state).districts
export const selectProvinces = (state: RootState) => selectFilterState(state).provinces
export const selectTehsils = (state: RootState) => selectFilterState(state).tehsils
