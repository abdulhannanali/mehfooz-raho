...
export default function VaccinationCentreCard(props: { id: string }) {
  const { id } = props;
  const parsedDeisgnation = vaccineDesignations.all;
  let vaccinationCentre = useAppSelector((state) =>
        ...
        <Card.Meta
          ...
          description={
            <React.Fragment>
              ...
              <Tag color="cyan">
                {vaccinationCentre.baseVaccinationCentre.district}
              </Tag>
              <Tag color="pink">
                {vaccinationCentre.baseVaccinationCentre.tehsil}
              </Tag>
            </React.Fragment>
          }
        ></Card.Meta>
